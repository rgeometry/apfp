{
  ...
  outputs = {
    ...
    flake-utils.lib.eachDefaultSystem (system: let
      ...
      # Build cargo-asm from source as a Nix derivation
      # Note: On first build, Nix will error with the correct hash values.
      # Update the sha256 and cargoHash with the values from the error message.
      cargoAsmTool = pkgs.rustPlatform.buildRustPackage rec {
        pname = "cargo-asm";
        version = "0.2.9";
        ...
        src = pkgs.fetchFromGitHub {
          owner = "pacak";
          repo = "cargo-asm";
          rev = "main"; # Using main branch - update to specific commit for reproducibility
          sha256 = "sha256-AAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAAA="; # Update after first build
        };
        ...
        meta = with pkgs.lib; {
          description = "Display the assembly, LLVM-IR and MIR generated by rustc";
          homepage = "https://github.com/pacak/cargo-asm";
