//! Geometric predicates for i16 coordinates.
//!
...
/// 2D coordinate with i16 components.
...
mod tests {
    ...
    fn orient2d_ccw() {
        let a = Coord::new(0, 0);
        let b = Coord::new(100, 0);
        let c = Coord::new(50, 100);
    ...
    fn orient2d_cw() {
        let a = Coord::new(0, 0);
        let b = Coord::new(50, 100);
        let c = Coord::new(100, 0);
    ...
    fn incircle_inside() {
        let a = Coord::new(0, 0);
        let b = Coord::new(100, 0);
        let c = Coord::new(0, 100);
        let d = Coord::new(30, 30);
