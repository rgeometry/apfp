//! Geometric predicates for i32 coordinates.
//!
...
/// 2D coordinate with i32 components.
...
mod tests {
    ...
    fn orient2d_large_values() {
        // Test with values that would overflow i32 * i32
        let big = i32::MAX / 2;
        let a = Coord::new(0, 0);
    ...
    fn cmp_dist_equal() {
        ...
        let p = Coord::new(3, 4); // dist = 5
        let q = Coord::new(5, 0); // dist = 5
